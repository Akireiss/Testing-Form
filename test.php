...
// i also want to, if the user choose and click any name from the dropdown, their students cases or anecdotal will be shown//
...
//this is the student model// protected $table = 'anecdotal';

protected $fillable = [
    'student_id',
    'case'
];//and this is the anecdotal model
